...
- 타입 템플릿 매개변수 :
  ...
  template<class T1, class T2 = T1> // T2에 대한 자료형이 입력되지 않는다면 T1과 같다
  class Sum {
      T1 n1;
      T2 n2;
  public:
  ...
  ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\c++\ch08\ex6.png)
  ...
  ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\c++\ch08\ex7.png)
  ...
  ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\c++\ch08\ex8.png)
  ...
  ```cpp
  ![ex9](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\c++\ch08\ex9.png)#include <iostream>
  ...
  ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\c++\ch08\ex9.png)
...
- 타입이 아닌 템플릿 매개변수 :
  ...
  ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\c++\ch08\ex5.png)
  ...
  ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\c++\ch08\ex10.png)
  ...
  - 열거형 타입
    ...
    > 결과 : 
    >
    > ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\c++\ch08\ex11.png)
...
- 템플릿 특수화란?
  ...
  (ex) 사칙연산 수행을 위한 함수 탬플릿에는 정수와 실수만 허용하고 문자나 일반 클래스는 제외한다.
