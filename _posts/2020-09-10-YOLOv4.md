...
- 3.2. Selection of BOF and BOS : 
  ...
  2. CmBN(Cross-mini Batch Normalization)
     ...
     ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\yolov4\yolov4_cbn.png)

     이렇게 구해진 새로운 평균과 분산을 이용하여 Normalization을 진행하는 것이 정통적인 **CBN**(Cross Batch Normalization) 방법이다. 

     ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\yolov4\yolov4_cbn2.png)

     

     YOLOv4의 저자는 CBN을 수정한 자신들만의 CmBN을 사용하였다고 말하며 그 구조는 다음과 같다. 하지만 왜 CBN을 수정할 필요가 있었는지에 대한 언급은 나와있지 않다.

     ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\yolov4\yolov4_cmbn.png)
  ...
  1. SPP-block([Spatial Pyramid Pooling](https://arxiv.org/pdf/1406.4729.pdf))
     ...
     ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\yolov4\yolov4_crop-ex.png)
     ...
     ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\yolov4\yolov4_spp.png)

     SPP layer는 다음 그림과 같은 구조로 이루어져 있다. SPP layer는 multi-level spatial bins를 사용하여 fixed-size 이미지 이슈에서 벗어날 수 있었다고 한다.

     ![](C:\Users\RILAB_JONSUFF\Desktop\Jonsuff\jonnote\images\yolov4\yolov4_spp2.png)
